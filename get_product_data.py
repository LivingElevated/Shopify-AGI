...
class ProductDataTool(BaseTool):
    ...
    """
    name: str = "Get Product Data"
    description: str = "Fetch all product information for a single product from your Shopify store."
    args_schema: Type[BaseModel] = ProductDataInput
